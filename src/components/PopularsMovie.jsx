    ...
    const GetMovies = async () => {
        try {
            ...
            if (searchTerm) {
                ...
                url = `https://api.themoviedb.org/3/discover/${mediaType}?api_key=d0c9f48906c0503c033778bb3aa582a1&page=${pages}&with_genres=${filter}&sort_by=popularity.desc`;
            }
                    ...
                    <div className="mt-6 flex flex-wrap gap-3">
                        {mediaType === 'movie' ? (
                            <>
                                ...
                                <button className='bg-gray-800 hover:bg-purple-600 text-white px-4 py-2 rounded-full transition-colors' 
                                        onClick={() => cambiarGenero(12)}>
                                    Aventura
                                </button>
                                <button className='bg-gray-800 hover:bg-purple-600 text-white px-4 py-2 rounded-full transition-colors' 
                                        onClick={() => cambiarGenero(16)}>
                                    Animación
                                </button>
                                <button className='bg-gray-800 hover:bg-purple-600 text-white px-4 py-2 rounded-full transition-colors' 
